...
export const T = {
  ...
  pickFromHistory: { pt: 'Usar imagem que já gerei', en: 'Use an image I already generated', es: 'Usar una imagen que ya generé' },
  pickFromHistoryTitle: { pt: 'Suas imagens geradas', en: 'Your generated images', es: 'Tus imágenes generadas' },
  pickFromHistorySub: {
    pt: 'Clique em uma imagem do seu histórico para usá-la como entrada.',
    en: 'Click an image from your history to use it as input.',
    es: 'Haz clic en una imagen de tu historial para usarla como entrada.',
  },
  galleryEmpty: {
    pt: 'Você ainda não gerou nenhuma imagem.',
    en: "You haven't generated any images yet.",
    es: 'Aún no has generado ninguna imagen.',
  },
  galleryError: {
    pt: 'Não foi possível carregar seu histórico.',
    en: 'Could not load your history.',
    es: 'No se pudo cargar tu historial.',
  },
  usingFromHistory: {
    pt: 'Usando imagem do seu histórico',
    en: 'Using an image from your history',
    es: 'Usando una imagen de tu historial',
  },
  change: { pt: 'Trocar', en: 'Change', es: 'Cambiar' },
  remove: { pt: 'Remover', en: 'Remove', es: 'Quitar' },
  loadingGallery: { pt: 'Carregando histórico…', en: 'Loading history…', es: 'Cargando historial…' },
  orSeparator: { pt: 'ou', en: 'or', es: 'o' },
