...
export const T = {
  ...
  undress: { pt: 'Despir', en: 'Undress', es: 'Desnudar' },
  faceswap: { pt: 'Troca de Rosto', en: 'Face Swap', es: 'Cambio de Rostro' },
  enhance: { pt: 'Melhorar', en: 'Enhance', es: 'Mejorar' },
  ...
  cost: { pt: '10 créditos', en: '10 credits' },
  costPerImage: { pt: '10 créditos / imagem', en: '10 credits / image' },
