...
export const TERMS: Record<Lang, LegalDoc> = {
  pt: {
    ...
    sections: [
      ...
      {
        heading: '5. Armazenamento das suas gerações',
        body: `O ${C.name} armazena os arquivos resultantes das suas gerações na nossa infraestrutura para que fiquem disponíveis no seu histórico, acessíveis para visualizar e baixar a qualquer momento enquanto a sua conta estiver ativa. Os arquivos podem ser removidos no encerramento da conta, mediante sua solicitação de exclusão, ou em caso de violação destes Termos. Recomendamos manter cópias locais do conteúdo que for importante. Apesar dos nossos esforços, não garantimos disponibilidade ininterrupta e não nos responsabilizamos por perda decorrente de falhas técnicas.`,
      },
      {
  ...
  en: {
    ...
    sections: [
      ...
      {
        heading: '5. Storage of your generations',
        body: `${C.name} stores the files resulting from your generations on our infrastructure so they remain available in your history, accessible to view and download at any time while your account is active. Files may be removed when you close your account, upon your deletion request, or in case of a breach of these Terms. We recommend keeping local copies of anything important. Despite our efforts, we do not guarantee uninterrupted availability and are not liable for loss caused by technical failures.`,
      },
      {
  ...
  es: {
    ...
    sections: [
      ...
      {
        heading: '5. Almacenamiento de tus generaciones',
        body: `${C.name} almacena los archivos resultantes de tus generaciones en nuestra infraestructura para que queden disponibles en tu historial, accesibles para ver y descargar en cualquier momento mientras tu cuenta esté activa. Los archivos pueden eliminarse al cerrar tu cuenta, a petición tuya de eliminación, o en caso de incumplimiento de estos Términos. Recomendamos mantener copias locales de lo que sea importante. Pese a nuestros esfuerzos, no garantizamos disponibilidad ininterrumpida y no nos hacemos responsables por pérdidas debidas a fallos técnicos.`,
      },
      {
  ...
  pt: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: `Mantemos sua conta e histórico de transações enquanto a conta estiver ativa e por até 5 anos após o encerramento, para fins fiscais. Armazenamos os arquivos resultantes das suas gerações na nossa infraestrutura (Supabase) para disponibilizá-los no seu histórico enquanto a conta estiver ativa. Esses arquivos são excluídos no encerramento da conta ou mediante sua solicitação de exclusão. Como o conteúdo gerado pode ser sensível ou íntimo, ele é vinculado à sua conta e não é compartilhado com terceiros, salvo provedores de infraestrutura necessários para operar o serviço.`,
      },
      {
  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: `We retain your account and transaction history while your account is active and up to 5 years after closure for tax purposes. We store the files resulting from your generations on our infrastructure (Supabase) to make them available in your history while your account is active. These files are deleted when you close your account or upon your deletion request. Because generated content may be sensitive or intimate, it is tied to your account and is not shared with third parties other than the infrastructure providers required to operate the service.`,
      },
      {
  ...
  es: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: `Conservamos tu cuenta y el historial de transacciones mientras la cuenta esté activa y hasta 5 años tras el cierre, con fines fiscales. Almacenamos los archivos resultantes de tus generaciones en nuestra infraestructura (Supabase) para ponerlos a tu disposición en tu historial mientras la cuenta esté activa. Esos archivos se eliminan al cerrar tu cuenta o cuando solicitas su eliminación. Dado que el contenido generado puede ser sensible o íntimo, está vinculado a tu cuenta y no se comparte con terceros salvo los proveedores de infraestructura necesarios para operar el servicio.`,
      },
      {
